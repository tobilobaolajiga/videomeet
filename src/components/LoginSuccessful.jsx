            ...
            <div className="flex flex-col gap-6 font-DMSans basis-[1000px] sm:text-center sm:justify-center sm:items-center lg:block lg:text-left">
              ...
              <div className="relative lg:w-full lg:mt-6 ">
                <input
                  ...
                  className="border border-[#c6c6c6] rounded-lg -mb-2 px-12 sm:w-[300px] lg:w-8/12 py-[9px] sm:placeholder:text-[13px] md:placeholder:text-[15px] placeholder:text-[#1F1F1F] placeholder:opacity-80 outline-none sm:text-[13px] lg:text-[15px]
              "
                />{' '}
                <img
                  src="/link.svg"
