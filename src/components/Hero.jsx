    ...
    <div className="  flex flex-col lg:flex-row bg-white items-center justify-between ">
      <div className="px-[55px]  flex justify-center items-center mt-6">
        <div className="flex flex-col gap-6 font-DMSans basis-[1000px] sm:text-center sm:justify-center sm:items-center lg:block lg:text-left">
          ...
          <div className="lg:w-[435px] flex sm:flex-col lg:flex-row sm:gap-[8px] lg:justify-between lg:mt-8 relative   ">
            <button
...
"
              >
                ...
                <li className="flex gap-[12px] items-center border-x border-b border-[#c6c6c6] pl-[12px] pr-[35px] py-[10px] rounded-b-md hover:bg-[#36AAD9] hover:text-white group cursor-pointer">
                  <svg
                    width="20"
                    height="17"
                    viewBox="0 0 20 21"
            ...
            <button
              ...
              onClick={showLogin}
            >
              <img src="/calendar.svg" alt="" className="w-[18px] h-[14px]" />
