export default function SquareGraphs() {
  return (
    <div className="flex w-fit ml-6">
      ...
      <div className="shadow-lg w-[257px] px-4 py-4 z-50 rounded-lg m-2 font-inter">
        ...
        <p className="text-[#1a1a1a] mt-6 text-[20px] font-semibold">473</p>
      </div>
      ...
      <div className="shadow-lg w-[257px] px-4 py-4 z-50 rounded-lg m-2 font-inter">
        <div className="flex justify-between ">
          <div className="flex ">
            ...
            <div>
              <p className="text-[14px] font-semibold">Scheduled Meeting</p>
              <p className="text-[12px] text-[#818181]">Total</p>
            </div>
          </div>
          <div>
        ...
        <p className="text-[#1a1a1a] mt-6 text-[20px] font-semibold">902</p>
      </div>
      <div className="shadow-lg w-[257px] px-4 py-4 z-50 rounded-lg m-2 font-inter">
        <div className="flex justify-between ">
          <div className="flex ">
