export default function ReportsNav() {
  return (
    <div className="flex justify-between items-center w-full pt-8 pb-[26px] h-fit border-b m-0  px-10">
      <div className="font-inter text-[12px] text-[#999999]">
        Pages /
        <span className="text-[#212121] font-medium"> Report & Analytics</span>
      </div>
